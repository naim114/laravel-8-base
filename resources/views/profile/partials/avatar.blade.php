<div class="text-center">
    ...
    <input type="file" id="fileInput" name="img[]" class="file hide" accept="image/*">
    ...
    <button type="button" id="submitAvatarButton" class="btn btn-primary btn-block mt-3 w-100 hide">
        <i class="fa fa-camera pr-2 pl-2"></i>
